...
public class HybridHashJoinPOperator extends AbstractHashJoinPOperator {
    ...
    private int userSuggestedMemorySize;
    ...
    public HybridHashJoinPOperator(JoinKind kind, JoinPartitioningType partitioningType,
        ...
        this(kind, partitioningType, sideLeftOfEqualities, sideRightOfEqualities, 0, maxInputSizeInFrames,
                aveRecordsPerFrame, fudgeFactor);
    }

    public HybridHashJoinPOperator(JoinKind kind, JoinPartitioningType partitioningType,
            List<LogicalVariable> sideLeftOfEqualities, List<LogicalVariable> sideRightOfEqualities,
            int userSuggestedMemorySize, int maxInputSizeInFrames, int aveRecordsPerFrame, double fudgeFactor) {
    ...
    private IOperatorDescriptor generateOptimizedHashJoinRuntime(JobGenContext context,
        ...
        localMemoryRequirements.setMemoryBudgetInFrames(userSuggestedMemorySize);
