...
public class NestedLoopJoinPOperator extends AbstractJoinPOperator {
    ...
    public NestedLoopJoinPOperator(JoinKind kind, JoinPartitioningType partitioningType, int userSuggestedJoinMemory) {
        super(kind, partitioningType);
        localMemoryRequirements.setMemoryBudgetInFrames(userSuggestedJoinMemory);
    }
