...
public class OptimizedHybridHashJoin {
    ...
    public String printInfo(HybridHashJoinUtil.SIDE side) {
        return HybridHashJoinUtil.printPartitionInfo(spilledStatus, side, numOfPartitions, probePSizeInTups,
                buildPSizeInTups, probeRFWriters, buildRFWriters, bufferManager);
    }
}
