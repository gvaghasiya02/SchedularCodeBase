...
public class MultiClassOrderedFIFOQueueOriginal implements IJobQueue {
    ...
    public MultiClassOrderedFIFOQueueOriginal(IJobManager jobManager, IJobCapacityController jobCapacityController) {
